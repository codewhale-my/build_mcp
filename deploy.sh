...
if [ "${ONLY_RESTART}" = "0" ]; then
  ...
  GUARD_FILES="static/index.html src/build_mcp/channels/core.py src/build_mcp/channels/qq_official.py src/build_mcp/web/main.py src/build_mcp/web/store.py src/build_mcp/client/conversation.py src/build_mcp/web/whatsnew.json"
  if [ "${FORCE}" = "0" ]; then
