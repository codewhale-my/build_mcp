...
if [ "${ONLY_RESTART}" = "0" ]; then
  ...
  GUARD_FILES="static/index.html static/riot.html src/build_mcp/channels/core.py src/build_mcp/channels/qq_official.py src/build_mcp/channels/selftest.py src/build_mcp/web/main.py src/build_mcp/web/store.py src/build_mcp/web/riot_token.py src/build_mcp/client/conversation.py src/build_mcp/web/whatsnew.json src/build_mcp/services/server.py src/build_mcp/services/valorant_sdk.py src/build_mcp/services/riot_dpop.py src/build_mcp/services/quote_sdk.py src/build_mcp/web/im_summary.py src/build_mcp/web/im_guard.py"
  if [ "${FORCE}" = "0" ]; then
